...
namespace WindowsFormsAppServer
{
    ...
    public partial class DataAccessServer : StandardServer
    {
        ...
        /// 
        /// 此方法允许子类创建其使用的任何其他节点管理器。 
        /// SDK总是创建一个CoreNodeManager来处理由规范定义的内置节点。 
        /// 预期任何其他NodeManager将处理特定于应用程序的节点。
        /// </remarks>
        protected override MasterNodeManager CreateMasterNodeManager(IServerInternal server, ApplicationConfiguration configuration)
        {
            ...
            nodeManagers.Add(new DataAccessServerNodeManager(server, configuration));//DataAccessServerNodeManager
            nodeManagers.Add(new OpcNodeManager(server, configuration));
